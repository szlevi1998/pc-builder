        ...
        <div className="form-container w-75 text-md-center">
            ...
            <Form>
                ...
                <Form.Group>
                    ...
                    {errors.userName && errors.userName.type === 'maxLength' && <span className="register-span">A maximális karakterek száma 25!</span> }                </Form.Group>
                <Form.Group>
                    ...
                    {errors.password && errors.password.type === 'maxLength' && <span className="register-span">A maximális karakterek száma 25!</span> }
                </Form.Group>
